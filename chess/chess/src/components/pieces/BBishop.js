...
export const BBishop = () =>{
  ...
  <g style={{opacity:'1', fill:'none', fillRule:'evenodd', fillOpacity:'1', stroke:'#000000', strokeWidth:'1.5', strokeLinecap:'round',
...
export const BBishop = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="-7 0 60 45">
      <g
        style={{
          opacity: "1",
          fill: "none",
...
>>>>>>> f01e246a8d8b371a1757852142d8fb3d1f51de9d
