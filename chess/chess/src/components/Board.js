...
export const Board = (props) => {
  ...
  const goUpK = (x, y, t) => {
    ...
    if (y < 7)
      if (
        board[x][y + 1].piece === null ||
        board[x][y + 1].piece.type.name.slice(0, 1) === enemy
      )
        t.push([x, y + 1]);
    if (y > 0)
      if (
  ...
  const goRightK = (x, y, t) => {
    ...
    if (x > 0)
      if (
        ...
        board[x - 1][y].piece.type.name.slice(0, 1) === enemy
      )
        t.push([x - 1, y]);
    if (x < 7)
      if (
  ...
  const King = (arr, s) => {
    ...
    if (
      y < 7 &&
      x > 0 &&
      (board[x - 1][y + 1].piece === null ||
        board[x - 1][y + 1].piece.type.name.slice(0, 1) === enemy)
    )
      temp.push([x - 1, y + 1]);
    if (
      y < 7 &&
      ...
      if (y < 7)
        if (board[x + 1][y + 1].piece !== null)
          if (
            y < 7 &&
            x < 7 &&
            board[x + 1][y + 1].piece.type.name.slice(0, 1) === "B"
          )
            temp.push([x + 1, y + 1]);
      if (y > 0)
        if (board[x + 1][y - 1].piece !== null)
      ...
      if (y < 7)
        if (board[x - 1][y + 1].piece !== null)
          if (
            y < 7 &&
            x > 0 &&
            board[x - 1][y + 1].piece.type.name.slice(0, 1) === "W"
          )
            temp.push([x - 1, y + 1]);
      if (y > 0)
        if (board[x - 1][y - 1].piece !== null)
